...
import (
	...
	_init_ "github.com/cdktn-io/cdktn-provider-archive-go/archive/v12/jsii"

	"github.com/cdktn-io/cdktn-provider-archive-go/archive/v12/dataarchivefile/internal"
...
func (j *jsiiProxy_DataArchiveFileSourceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataArchiveFileSourceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataArchiveFileSourceOutputReference {
	_init_.Initialize()

	if err := validateNewDataArchiveFileSourceOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func NewDataArchiveFileSourceOutputReference_Override(d DataArchiveFileSourceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataArchiveFileSourceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
