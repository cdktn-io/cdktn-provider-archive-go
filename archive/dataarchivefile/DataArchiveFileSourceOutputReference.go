...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataArchiveFileSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
