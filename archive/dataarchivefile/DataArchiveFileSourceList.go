...
func (j *jsiiProxy_DataArchiveFileSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataArchiveFileSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataArchiveFileSourceList {
	_init_.Initialize()
...
func NewDataArchiveFileSourceList_Override(d DataArchiveFileSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataArchiveFileSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataArchiveFileSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataArchiveFileSourceList) Resolve(context cdktn.IResolveContext) interface{} {
