...
func (d *jsiiProxy_DataArchiveFileSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataArchiveFileSourceList) Resolve(context cdktf.IResolveContext) interface{} {
