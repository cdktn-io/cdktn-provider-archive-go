// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for archive.
...
// You can continue to use the archive provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-archive-go/archive/v11
