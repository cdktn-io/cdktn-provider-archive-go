...
func (f *jsiiProxy_FileSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FileSourceList) Resolve(context cdktf.IResolveContext) interface{} {
