...
func (j *jsiiProxy_FileSourceList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFileSourceList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FileSourceList {
	_init_.Initialize()
...
func NewFileSourceList_Override(f FileSourceList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FileSourceList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FileSourceList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FileSourceList) Resolve(context cdktn.IResolveContext) interface{} {
