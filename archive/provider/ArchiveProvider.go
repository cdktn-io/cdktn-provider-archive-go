...
import (
	...
	"github.com/cdktn-io/cdktn-provider-archive-go/archive/v11/provider/internal"
...
func ArchiveProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
