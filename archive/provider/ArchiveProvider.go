...
import (
	...
	"github.com/cdktn-io/cdktn-provider-archive-go/archive/v14/provider/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/archive/2.8.1/docs archive}.
...
func (j *jsiiProxy_ArchiveProvider) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ArchiveProvider) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/archive/2.8.1/docs archive} Resource.
func NewArchiveProvider(scope constructs.Construct, id *string, config *ArchiveProviderConfig) ArchiveProvider {
	...
	_jsii_.Create(
		"@cdktn/provider-archive.provider.ArchiveProvider",
...
func ArchiveProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateArchiveProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ArchiveProvider_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateArchiveProvider_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ArchiveProvider_IsTerraformProvider(x interface{}) *bool {
	...
	if err := validateArchiveProvider_IsTerraformProviderParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_ArchiveProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ArchiveProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ArchiveProvider) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ArchiveProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
